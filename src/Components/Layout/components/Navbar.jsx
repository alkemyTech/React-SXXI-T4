    ...
    return (
        <header>
            ...
            <nav className=''>
                ...
                {mobile && <div className='md:hidden grid grid-cols-3'>
                    {
                        menuArr.map(x => (

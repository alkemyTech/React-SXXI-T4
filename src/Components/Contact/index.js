				...
				<div className="p-4">
					...
					<div className="py-2">
						<h3 className="font-medium">
							...
							<span className="font-normal">
								{address ||
									" Paraguay 733, (C1057AAI) Ciudad Autónoma de Buenos Aires"}
							</span>
						</h3>
						<h3 className="font-medium">
							Telefono:{" "}
							<span className="font-normal">{phone || " 1160112988"}</span>
						</h3>
					</div>
					...
					<div className="flex justify-center items-center gap-4 ">
						<div className="flex items-center justify-center w-1/2 h-12 rounded-xl shadow text-center bg-white">
							<a href={facebookUrl || "https://web.facebook.com/Somos_mass"}>
								<FaFacebook className="text-blue-500" size={30} />
							</a>
						</div>
						<div className="flex items-center justify-center w-1/2 h-12 rounded-xl shadow text-center bg-white">
							<a href={linkedinUrl || "https://www.linkedin.com/SomosMass"}>
								<FaLinkedin className="text-blue-700" size={30} />
							</a>
						</div>
						<div className="flex items-center justify-center w-1/2 h-12 rounded-xl shadow text-center bg-white">
							<a href={twitterUrl || "https://www.twitter.com/SomosMas"}>
						...
						<div className="flex justify-center items-center w-1/2 h-12 rounded-xl shadow bg-white">
							<a
								...
								href={instagramUrl || "https://www.instagram.com/Somos_mas"}
							>
								<img

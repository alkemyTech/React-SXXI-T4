...
const TableInputSearch = ({ placeholder, inputFilter, setInputFilter }) => {
	...
	return (
		<div>
			<div className=" h-full h-10 flex flex-row justify-start border border-gray-400 items-center rounded">
			...
			{search.length > 0 && search.length <= 3 && <p className=" md:absolute text-xs text-red-500">*Minimo 3 caracteres</p>}
		</div>
	);
};
